        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.abs(mov_x) < Math.abs(mov_y) && canDel && mov_y < frameLayout.getWidth() / 4) {
                    frameLayout.measure(View.MeasureSpec.makeMeasureSpec(measureWidth, View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(measureHeight, View.MeasureSpec.AT_MOST));
